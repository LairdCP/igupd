...
class UpdateService(dbus.service.Object):
    def __init__(self, bus_name):
        super(UpdateService, self).__init__(
            bus_name, "/com/lairdtech/security/UpdateService"
        )

    @dbus.service.method(
        "com.lairdtech.security.UpdateInterface", in_signature="s", out_signature="i"
    )
    ...
    @dbus.service.method(
        "com.lairdtech.security.public.UpdateInterface",
        in_signature="b",
        out_signature="i",
    )
